...
export type ViewSelectorUIProps = {
  ...
  onGridViewChange: (event: React.MouseEvent<HTMLElement>, gridViewOption: GridViews) => void;
};

export const ViewSelectorUI = ({ activeGridView, onGridViewChange }: ViewSelectorUIProps) => (
  <ToggleButtonGroup
